            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="/backend/images/products/medium/{{$productDetails->image}}" alt="First slide"> </div>
                            @foreach($productAltImages as $productAltImage)
                                <div class="carousel-item"> <img class="d-block w-100" src="/backend/images/product_image/medium/{{$productAltImage->image}}" alt="Second slide"> </div>
                            @endforeach
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="/backend/images/products/medium/{{$productDetails->image}}" alt="" />
                            </li>

                            @foreach($productAltImages as $productAltImage)
                                <li data-target="#carousel-example-1">
                                    <img class="d-block w-100 img-fluid" src="/backend/images/product_image/medium/{{$productAltImage->image}}" alt="" />
                                </li>
                            @endforeach
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <form name="addtoCart" method="post" action="{{url('/add-cart')}}">
                        ...
                        <input type="hidden" id="price" value="{{$productDetails->product_price}}" name="price">
                        <div class="single-product-details">
                        <h2>Tên sản phẩm :{{$productDetails->product_name}}</h2>
                        <h5 id="getPrice">Giá sản phẩm : <del></del>{{$productDetails->product_price}}</h5>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="form-group quantity-box">
                                    ...
                                    <input class="form-control" value="0" name="quantity" min="0" max="20" type="number">
                                </div>
                            </li>
                        </ul>
