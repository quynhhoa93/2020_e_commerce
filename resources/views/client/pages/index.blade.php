    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            ...
            <li class="{{$banner->text_style}}">
                <img src="backend/images/banners/large/{{$banner->image}}" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="list-group-collapse sub-men">
                                    ...
                                    <div class="collapse show" id="{{$cat->id}}" data-parent="#list-group-men">
                                        <div class="list-group">
                                            ...
                                            <a href="{{route('categories',$subCat->id)}}" class="list-group-item list-group-item-action  ">{{$subCat->name}} <small class="text-muted"></small></a>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="backend/images/products/medium/{{$product->image}}" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                        ...
                                                        <a class="cart" href="{{route('product_details',$product->id)}}">chi tiết sản phẩm</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
